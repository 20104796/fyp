<template>
  <div class="audio-bg">
    ...
    <div class="audio-content">
      ...
      <div class="audio-avatar"> <img src="../../static/sidebar/avatar.jpg" alt=""
                                      style="width: 100px;height: 100px;object-fit: cover;object-position: center;"></div>
      <div class="audio-choses" v-if="beInviter && !flag">
        <div style="color: white;">{{ username }} initiates a voice call with you</div>
        <div>
      ...
      <div class="audio-Inviter" v-if="!beInviter && !flag">
        <div style="color: white;">You initiate a voice call to {{ username }}</div>
        <img src="../../static/chat/reject.png" alt="" width="50" @click="rejectAudio">
      </div>
