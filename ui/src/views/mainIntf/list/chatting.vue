  ...
  <div class="chat-list">
    <div class="chat-item" v-for="item in ChatList" :key="item.room" @click="chooseRoom(item)"
      ...
      <div class="chat-avatar">
        <img :src="item.avatar ? getAvatarPath(item.avatar) : require('@/static/logo.png')" alt="" width="45"
      ...
      <div class="chat-time">
        ...
        <div class="chat-msg" v-if="item.unreadCount != 0">
...
<script>
import { getMessageList } from '@/api/msg';
